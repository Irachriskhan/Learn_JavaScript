...
const headingText2 = document.createTextNode(
  "This is the heading TWO replacing the Heading FOUR"
);
...
const headingText1 = document.createTextNode(
  "This is the heading ONE added bofore the NEW DIV"
);
...
xhr.open("GET", url); // Accessing the file
...
// Fetch is built-in
// It is romise based
// XHR is not wrong, you can complete our upcoming examples and projects using XHR,
// fetch is just an alternative approch. It is simpler, and clear syntax
...
//   .then(
//     (resp) => resp.json()
//     // console.log(resp); // check accessibility of the url
//   )
//   .then(
//     (data) => console.log(data) // accessing the objects from people.json file
//   )
//   .catch((err) => console.log(err));

const gererateJson = document.querySelector(".gereratejson");

gererateJson.addEventListener("click", async () => {
  // fetch(url)
  //   .then((resp) => resp.json())
  //   .then((data) => console.log(displayElements(data)))
  //   .catch((err) => console.log(err));
